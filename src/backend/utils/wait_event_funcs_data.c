 ...
 */
	...
	{"Client", "WaitForWalFlush", "Waiting for WAL flush to reach a target LSN on a primary or standby"},
	{"Client", "WaitForWalReplay", "Waiting for WAL replay to reach a target LSN on a standby"},
	{"Client", "WaitForWalWrite", "Waiting for WAL write to reach a target LSN on a standby"},
	...
	{"IPC", "DWBufBatchSync", "Waiting for double write buffer batch sync to complete."},
